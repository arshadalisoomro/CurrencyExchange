...
package org.soomro.android.cuco.views;
...
public class ResizeableEditText extends AppCompatEditText {
    ...
    public ResizeableEditText(Context context) {
        this(context, null);
    }

    public ResizeableEditText(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ResizeableEditText(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        final TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.ResizeableEditText, defStyle, 0);
        mMaximumTextSize = a.getDimension(
                R.styleable.ResizeableEditText_maxTextSize, getTextSize());
        mMinimumTextSize = a.getDimension(
                R.styleable.ResizeableEditText_minTextSize, getTextSize());
        mStepTextSize = a.getDimension(R.styleable.ResizeableEditText_stepTextSize,
